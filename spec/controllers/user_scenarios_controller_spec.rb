...
describe UserScenariosController do
  render_views
    ...
    describe "with valid params" do
      it "creates a new user_scenario" do
        lambda {
          ...
          response.should redirect_to(user_scenario_url(assigns(:user_scenario)))
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_scenario" do
        ...
        response.should redirect_to(user_scenario_url(@user_scenario))
      end
    end
  ...
  describe "DELETE destroy" do
    it "destroys the requested user_scenario" do
      lambda {
        ...
        response.should redirect_to(user_scenarios_url)
      }.should change(UserScenario, :count)
    end
  end
end
