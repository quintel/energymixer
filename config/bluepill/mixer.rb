# Gasmixer Bluepill configuration
# -----------------------------
#
...
rails_root = ENV['RAILS_ROOT']   || "/home/ubuntu/apps/mixer/current"

log_file   = "#{rails_root}/log/bluepill.log"

Bluepill.application('mixer', log_file: log_file) do |app|
  app.process('unicorn') do |process|
    ...
    process.start_command =
      ...
      "-c #{rails_root}/config/unicorn/mixer.rb " \
      "-E #{rails_env}"
