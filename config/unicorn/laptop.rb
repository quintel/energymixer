worker_processes 2
working_directory '/Users/admin/Sites/energymixer'
...
listen '/Users/admin/Sites/energymixer/tmp/unicorn.sock', backlog: 64

# File containing the mixer process ID.
pid '/Users/admin/Sites/energymixer/tmp/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/Users/admin/Sites/energymixer/log/unicorn.log'
stdout_path '/Users/admin/Sites/energymixer/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/Users/admin/Sites/energymixer/tmp/unicorn.pid.oldbin'
