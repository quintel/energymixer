worker_processes 2
working_directory '/u/apps/gasmixer/current'
...
listen '/u/apps/gasmixer/shared/pids/unicorn.sock', backlog: 64

# File containing the mixer process ID.
pid '/u/apps/gasmixer/shared/pids/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/u/apps/gasmixer/shared/log/unicorn.log'
stdout_path '/u/apps/gasmixer/shared/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/u/apps/gasmixer/shared/pids/unicorn.pid.oldbin'
